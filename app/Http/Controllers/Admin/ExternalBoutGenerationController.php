...
class ExternalBoutGenerationController extends Controller
{
    ...
    {
        $external_competition = ExternalCompetition::where('id',$external_comp_id)->first();
        return Excel::download(new ExternalCompDataExport($external_competition->id), 'Kumite_ExternalCompetition_'.$external_competition->id.'.xlsx');
    }
    ...
    public function board_list_download_bout($external_comp_id, $bout_id)
    {
        ...
        $headers = [
            ...
            'Content-Disposition' => 'attachment; filename="' . $external_comp_id."_". $bout_id.".pdf" . '"',
        ];
