                    ...
                    <div class="modal-body">
                        <form class="px-4 needs-validation" id="form_{{$details_key}}" name="form_{{$details_key}}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="bout_number" name="bout_number"
                                    placeholder="Bout Number">
                            ...
                            <input type="hidden" class="form-control" id="gender" name="gender"
                                value="{{$participants->gender}}">

                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary"
                            data-href="{{URL::to('admin/competition/board/'.$decrypted_comp_id.'/kata/bout/'.$bout_id.'/'.$custom_bout_id.'/'.$participants->id.'/save_change_bout')}}"
