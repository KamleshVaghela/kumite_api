...
<div class="d-flex justify-content-center">
    <div class="d-inline p-4 text-white">
        <a target="_blank"
            href="{{URL::to('admin/competition/board/'.$decrypted_comp_id.'/kata/bout/'.$bout_id.'/'.$custom_bout_id.'/download_bout')}}">
...
<ul class="list-group">
    ...
    <li class="list-group-item list-group-item-action d-flex list-group-item-two-line">
        ...
        <span class="list-group-item-text" onclick="loadContentDetails(this, 'karate_ka')"
            data-href="{{URL::to('admin/competition/board/'.$decrypted_comp_id.'/kata/bout/'.$bout_id.'/'.$custom_bout_id.'/'.$rec->id.'/karate_ka')}}"
        ...
        <span>
            ...
            <a class="btn btn-icon ml-auto" href="#">
                <span class="material-icons" onclick="loadContentDetails(this, 'karate_ka')"
                    data-href="{{URL::to('admin/competition/board/'.$decrypted_comp_id.'/kata/bout/'.$bout_id.'/'.$custom_bout_id.'/'.$rec->id.'/change_bout')}}"
                    data-details_key="change_bout_details" name="li_change_bout">send</span>
            </a>
            @endif
        </span>
    </li>
