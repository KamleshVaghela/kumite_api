...
<div class="d-flex justify-content-center">
    <div class="d-inline p-4 text-white">
        <a target="_blank"
            href="{{URL::to('admin/external_bout/board/'.$external_comp_id.'/bout/list/'.$boutObj->id.'/download_bout_kata')}}">
...
<ul class="list-group">
    ...
    <li class="list-group-item list-group-item-action d-flex list-group-item-two-line">
        ...
        <span class="list-group-item-text" onclick="loadContentDetails(this, 'karate_ka')"
            data-href="{{URL::to('admin/external_bout/board/'.$external_comp_id.'/bout/list/'.$rec->id.'/karate_ka_kata/'.$rec->participants_id)}}"
