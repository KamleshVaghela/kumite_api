    ...
    <div class="container-full">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">School Master</li>
            </ol>
        </nav>
    ...
    <div class="navdrawer-content">
        ...
        <form class="px-4" id="form_filter">
            ...
            <div class="form-group textfield-box form-ripple">
                ...
                <small id="district_error" class="form-text post_error"></small>
            </div>

            <button id="btn_filter_data" type="button" class="btn btn-primary" data-href="{{URL::to('admin/school_master/report')}}">Filter</button>
        </form>
    </div>
  </div>
  <div class="bd-example">
    <div class="fab-actions">
        <button id="btnFabAdd" aria-expanded="false" data-href="{{URL::to('admin/school_master/create')}}"  aria-haspopup="true" class="btn btn-float btn-primary" type="button">
