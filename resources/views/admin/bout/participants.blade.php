...
<div class="d-flex justify-content-center">
    <div class="d-inline p-4 text-white">
        <a target="_blank"
            href="{{URL::to('admin/competition/board/'.$decrypted_comp_id.'/bout/'.$bout_id.'/'.$custom_bout_id.'/download_bout')}}">
            <i class="material-icons" data-toggle="tooltip" title="Download Bout Pdf">file_download</i>
        </a>
    </div>
    <div class="d-inline p-4 text-white">
        <a href="#" onclick="loadLoadDetails(this)"
            data-href="{{URL::to('admin/competition/board/'.$decrypted_comp_id.'/bout/'.$bout_id.'/'.$custom_bout_id.'/clear_bout_result')}}"
            data-details_key="clear_bout_result">
            <i class="material-icons" data-toggle="tooltip" title="Clear Result">clear_all</i>
        </a>
    </div>
