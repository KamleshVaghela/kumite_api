    ...
    <div class="container-full">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Result Board</li>
            </ol>
        </nav>
        ...
        <input id="btn_filter_data" type="hidden" data-href="{{URL::to('admin/competition/board/'.$decrypted_comp_id.'/bout/results/report')}}" />
